...
/**
 * The Class Sogetilevalbenchavg.
 */
@Entity
@Table(name = "sogetilevalbenchavg")
public class Sogetilevalbenchavg extends AbstractEntity
{
   /**
   ...
   public boolean equals(Object obj)
   {
      ...
      Sogetilevalbenchavg other = (Sogetilevalbenchavg) obj;
   ...
   {
      return "Sogetilevalbenchavg [productivityAvg=" + this.productivityAvg + ", affordAvg=" + this.affordAvg + ", rewardAvg=" + this.rewardAvg + ", promotionAvg=" + this.promotionAvg
            + ", frequencyAvg=" + this.frequencyAvg + ", avgCalculationDate=" + this.avgCalculationDate + "]";
   }
